...
function Navbar({ onOpenContact }) {
  ...
  const themeLabel = isDark ? "Mudar para modo claro" : "Mudar para modo escuro";
  const themeIcon = isDark ? "☀️" : "🌙";

  return (
    <header className={`navbar ${scrolled ? "navbar--scrolled" : ""}`} id="top">
      <div className="container navbar__content">
        <a href="#top" className="navbar__brand" aria-label="Potencializa - Início">
          <img src={brandImage} alt="" />
          <span>Potencializa</span>
        </a>

        <nav className={`navbar__nav ${open ? "is-open" : ""}`} aria-label="Menu principal">
          <ul>
            <li>
            ...
            <li>
              <a href="#video-packages" onClick={closeMenu}>
                Pacotes
              </a>
            </li>
            <li>
        ...
        <div className="navbar__actions">
          ...
          <button type="button" className="btn btn--primary btn--transparent btn--specialist" onClick={onOpenContact}>
